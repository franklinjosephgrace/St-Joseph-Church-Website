...
<body>
	...
	<center>
	<font color="green" size="30" style="font-family:cooper;">CONFORMATION</font>
	</center>
	<br><br>
	<form name="form1" action="" method="post">
		<table id="customers" align="center" style="font-family:verdana;">
			...
			<tr>
				<td>Enter Conformation Date</td>
				<td><input type="text" name="cdob"></td>
			</tr>
			<tr>
				<td>Enter Conformation Place</td>
...
{
	mysqli_query($link,"insert into conformation values('$_POST[regno]','$_POST[name]','$_POST[dob]','$_POST[fname]','$_POST[mname]',  '$_POST[bfname]','$_POST[bmname]','$_POST[bdob]','$_POST[address]','$_POST[bpname]','$_POST[hcdob]','$_POST[hcplace]','$_POST[cdob]','$_POST[cplace]')");
}

if (isset($_POST["submit2"]))
{
	mysqli_query($link,"delete from conformation where regno='$_POST[regno]'");
}

if (isset($_POST["submit3"]))
{
	mysqli_query($link,"update conformation set regno='$_POST[regno]' where regno='$_POST[regno]'");
}

if (isset($_POST["submit4"]))
{
	$res=mysqli_query($link,"select * from conformation");
	...
	echo "<tr>";
		...
		echo "<th>"; echo "Conformation Date"; echo "<th>";
		echo "<th>"; echo "Conformation Place"; echo "<th>";
	echo "</tr>";
	while ($row=mysqli_fetch_array($res)) 
	{
		...
		echo "<td>"; echo $row["cdob"]; echo "<td>";
		echo "<td>"; echo $row["cplace"]; echo "<td>";
		echo "</tr>";
	}
	echo "</table>";
}
...
{
	$res=mysqli_query($link,"select * from conformation where regno='$_POST[regno]'");
	echo "<table border=1 align=center id=customers>";
	echo "<tr>";
		echo "<th>"; echo "S.No"; echo "<th>";
		echo "<th>"; echo "Name"; echo "<th>";
