...
<body>
	...
	<center>
	<font color="green" size="30" style="font-family:cooper;">BAPTISM</font>
	</center>
	<br><br>
...
{
	mysqli_query($link,"insert into baptism values('$_POST[regno]','$_POST[name]','$_POST[dob]','$_POST[fname]','$_POST[mname]',  '$_POST[bfname]','$_POST[bmname]','$_POST[bdob]','$_POST[address]','$_POST[bpname]')");
}

if (isset($_POST["submit2"]))
{
	mysqli_query($link,"delete from baptism where regno='$_POST[regno]'");
}

if (isset($_POST["submit3"]))
{
	mysqli_query($link,"update baptism set regno='$_POST[regno]' where regno='$_POST[regno]'");
}

if (isset($_POST["submit4"]))
{
	$res=mysqli_query($link,"select * from baptism");
